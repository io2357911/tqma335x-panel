...
Управление изделием осуществляется по протоколу UDP в виде 2-ух запросов:
- чтение всех тегов
- запись тега

Тег - это некоторая внутренняя переменная изделия.
...
Описание тегов изделия содержится в отдельном файле tags.efs.
